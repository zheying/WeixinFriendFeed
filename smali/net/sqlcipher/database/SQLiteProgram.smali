...
.method constructor <init>(Lnet/sqlcipher/database/SQLiteDatabase;Ljava/lang/String;)V
    ...
    .line 45
    iput v4, p0, Lnet/sqlcipher/database/SQLiteProgram;->nHandle:I

    .line 58
    iput v4, p0, Lnet/sqlcipher/database/SQLiteProgram;->nStatement:I
    ...
    iput-object v2, p0, Lnet/sqlcipher/database/SQLiteProgram;->mSql:Ljava/lang/String;
    ...
    .line 66
    iget v2, p1, Lnet/sqlcipher/database/SQLiteDatabase;->mNativeHandle:I
    ...
    iget v4, v4, Lnet/sqlcipher/database/SQLiteCompiledSql;->nStatement:I
    ...
    iget v0, v2, Lnet/sqlcipher/database/SQLiteCompiledSql;->nStatement:I
    ...
    const-string v4, "** possible bug ** Created NEW DbObj (id#"
    ...
    const-string v4, ") because the previously created DbObj (id#"
    ...
    const-string v4, ") was not released for sql:"
